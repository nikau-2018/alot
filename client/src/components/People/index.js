  ...
  return (
    <div className={styles.body}>
      ...
      <Grid columns={2}>
        <Grid.Column>
          <Segment basic>
            <h3>Amanada Chapman</h3>
            <Image src={'/people/amanda.jpg'} size='medium' circular/>
            <p>Amanda Chapman​ established the Auckland Community Fridge, NZ’s first free food sharing fridge. Amanda blogs about waste reduction and her tiny 
        ...
        <Grid.Column>
          <Segment basic>
            <h2>Tom Greer</h2>
            <Image src={`http://www.placepuppy.net/400/250`} size='medium' circular/>
