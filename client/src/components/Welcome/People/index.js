      ...
      <Grid stackable columns={2} divided>
        <Grid.Row>
          <Grid.Column>
            ...
            <p className={styles.p}>Amanda Chapman​ established the Auckland Community Fridge, NZ’s first free food sharing fridge. She blogs       about waste reduction and her tiny house build. Amanda works for We Compost and United Sustainable Sisters
