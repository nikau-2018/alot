  ...
  return knex('workshops').del()
    .then(function () {
      return knex('workshops').insert([
        ...
        {id: 88804, category_id: 77701, name: 'Make a Cushion Cover', description: '3 hours *Great for beginners', body: 'Create  a cushion cover of your own.', image: '/workshop-images/cushion-cover.jpg', instructor: 'Delta Hayward', date_time: moment.utc('2018-10-07 20:00 +0000', 'YYYY-MM-DD HH:mm Z').format()},
