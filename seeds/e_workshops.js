  ...
  return knex('workshops').del()
    .then(function () {
      return knex('workshops').insert([
        ...
        {id: 88803, category_id: 77704, name: 'Build a Birdhouse Workshop', description: '3 hours, kid-friendly', body: 'In this workshop you will build your own wooden birdhouse. Once completed, it can be decorated with paint.', image: '/workshop-images/birdhouse.jpg', instructor: 'Peter Parker', date_time: null},
        {id: 88803, category_id: 77701, name: 'Cushion Workshop', description: '3 hours', body: 'Create  a cushion cover of your own.', image: '/workshop-images/cushion-cover.jpg', instructor: 'Delta Hayward', date_time: null}
      ])
    })
}
