  ...
  return knex('workshops').del()
    .then(function () {
      return knex('workshops').insert([
        ...
        {id: 88802, catergory_id: 77702, name: 'Home Gardening Workshop', description: '2.5 hours', body: 'Learn how to grow food for your family in your own backyard', image: '/placeholder-image.jpeg', instructor: 'John Smith', date_time: '24/11/2018'},
