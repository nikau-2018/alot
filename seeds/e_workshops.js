  ...
  return knex('workshops').del()
    .then(function () {
      return knex('workshops').insert([
        ...
        {id: 88807, category_id: 77703, name: 'Paint a Room', description: '2 hours', body: 'Learn how to paint walls, trims and ceilings. Also get tips on paint prep and using paint tools', image: '/workshop-images/painting-room.jpg', instructor: 'Kelly Webber', date_time: null}
      ])
    })
}
