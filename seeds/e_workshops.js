  ...
  return knex('workshops').del()
    .then(function () {
      return knex('workshops').insert([
        ...
        {id: 88804, category_id: 77701, name: 'Cushion Workshop', description: '3 hours', body: 'Create  a cushion cover of your own.', image: '/workshop-images/cushion-cover.jpg', instructor: 'Delta Hayward', date_time: null}
      ])
    })
}
