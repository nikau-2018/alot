  ...
  return knex('tools').del()
    .then(function () {
      return knex('tools').insert([
        ...
        {id: 55502, category_id: 77703, name: 'Paint Brush', description: 'Haydn Synthetic Paint Brush', body: '100mm wide *Ergonomically designed beaver tail handle *Suitable for fence painting', image: '/tool-images/paint-brush.jpg', stocked: 1},
        ...
        {id: 55506, category_id: 77702, name: 'Rake', description: 'Saxon Long Handle 14 Tine Garden Rake', body: 'Long timber handle *Ideal for raking and clearing soils, leaves and stones ', image: '/tool-images/rake.jpg', stocked: 1},
        ...
        {id: 55508, category_id: 77703, name: 'Paint Roller', description: 'Paint Partner Roller Frame & Roller Cover 230mm', body: 'Comfortable grip *Sturdy steel frame *Washable and reusable', image: '/tool-images/paint-roller.jpg', stocked: 1},
        ...
        {id: 55513, category_id: 77701, name: 'Needles', description: 'Birch Crewel Needles', body: 'Versatile all-purpose needles *Durable and easy to handle', image: '/tool-images/needles.jpg', stocked: 1}
      ])
    })
}
